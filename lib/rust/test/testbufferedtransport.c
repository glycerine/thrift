...
#include <thrift/rust/transport/thrift_socket.h>
#include <thrift/rust/transport/thrift_server_transport.h>
#include <thrift/rust/transport/thrift_server_socket.h>

#define TEST_DATA { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j' }

#include "../src/thrift/rust/transport/thrift_buffered_transport.c"
