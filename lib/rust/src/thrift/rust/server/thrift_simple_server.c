...
#include <thrift/rust/server/thrift_simple_server.h>
#include <thrift/rust/transport/thrift_transport_factory.h>
#include <thrift/rust/protocol/thrift_protocol_factory.h>
#include <thrift/rust/protocol/thrift_binary_protocol_factory.h>
